...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    showOnMain: false,
    title: 'TechScope',
    subtitle: '최신 기술 뉴스 큐레이션 웹앱',
    description:
      '기술 뉴스와 블로그를 카테고리별로 필터링하고, 최신 트렌드를 쉽게 확인할 수 있는 개발자 전용 뉴스 큐레이션 플랫폼입니다.',
    year: '2025.06',
    client: 'Personal Project',
    desc: 'TechScope는 기술 트렌드 콘텐츠를 수집하고 분류하는 데 중점을 둔 뉴스 큐레이션 웹 애플리케이션입니다. 사용자는 프론트엔드, 백엔드, AI, 디자인 등의 카테고리를 선택하여 관련 기술 뉴스를 탐색할 수 있으며, 검색 기능과 무한 스크롤을 통해 사용자 경험을 강화했습니다. 또한, React Query를 활용한 데이터 캐싱과 Next.js의 파일 기반 라우팅 구조를 적용하여 퍼포먼스와 개발 효율을 고려하였습니다.',
    image: ['/images/pattern/ts.png'],
    period: '2025.05 - 2025.06',
    links: {
      live: 'https://tech-nine-rust.vercel.app',
      github: 'https://github.com/zio-s/tech',
    },
    responsibilities: [
      '기술 뉴스 콘텐츠를 Dev.to API를 통해 가져오고, 카테고리별 필터링 및 검색 기능 구현',
      'React Query를 활용해 무한 스크롤 기능과 데이터 캐싱 처리',
      '사용자 친화적인 UI를 고려한 Tailwind CSS 기반의 반응형 레이아웃 구현',
      'Next.js 15 app 디렉토리 구조를 활용한 페이지 라우팅 및 동적 URL 처리',
    ],
    techStack: ['Next.js', 'Tailwind CSS', 'React Query', 'JavaScript', 'Vercel', 'framer-motion'],
  },
];
